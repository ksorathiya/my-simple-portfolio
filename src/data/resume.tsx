...
export const DATA = {
  ...
  summary:
    "<br/> I’m a **PMP-certified Technical Project Manager** and **Full Stack Developer** with 8+ years of experience leading cross-functional teams and delivering solutions across **logistics, digital commerce, healthcare, and SaaS**. <br/> <br/> With expertise in **Node.js, React.js, AWS, and Docker**, I align technical solutions with business goals, driving innovation through **automation and DevOps**. <br/> <br/>I’ve helped scaled teams, managed client relations, and increased client revenue by 2.5x. I’m passionate about solving real-world problems efficiently while ensuring user satisfaction. Outside of work, I attend meetups, cook, dive into worldly affairs, attend industry conferences and provide mentorship.",
  avatarUrl: "/me.png",
  skills: {
    "Backend Development": [
      "Node.js",
